...
<fieldset class="inline-edit-col-right">
    <div class="inline-edit-col">
        ...
        // javascript later.
        echo '<input type="text" name="_content_audit_owner" />';
        ?>
	</div>
</fieldset>
<?php
